...
public class Binario extends Algoritmo{
    ...
    public void codificar(DTO dto){
        //System.out.println("Clase Algoritmo, m�todo Codificar. B�sicamente, ac� no deber�a entrar");
    ...
    public void decodificar(DTO dto){
        //System.out.println("Clase Algoritmo, m�todo Decodificar. B�sicamente, ac� no deber�a entrar");
        String frase = dto.getFrase();
